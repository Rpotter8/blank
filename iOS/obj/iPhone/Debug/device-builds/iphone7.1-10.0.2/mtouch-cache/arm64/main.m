...
extern void *mono_aot_module_HandiMaps_B_iOS_info;
...
extern void *mono_aot_module_HandiMaps_B_info;
...
extern void *mono_aot_module_EpPathFinding_cs_info;
extern void *mono_aot_module_C5_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_HandiMaps_B_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_HandiMaps_B_info);
	...
	mono_aot_register_module (mono_aot_module_EpPathFinding_cs_info);
	mono_aot_register_module (mono_aot_module_C5_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "HandiMaps_B.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
